...
const docTemplate = `{
    ...
    "paths": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.ChangeCustomerStatusRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/service-orders/{id}/budget-approval": {
            "post": {
                "consumes": [
                    "application/json"
                ],
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.BudgetApprovalWebhookRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.AddPartToOrderRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.AddServiceToOrderRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "dto.BudgetApprovalWebhookRequest": {
            "type": "object",
            "required": [
                "decision"
            ],
        ...
        "dto.ChangeCustomerStatusRequest": {
            "type": "object",
            "required": [
                "status"
            ],
        ...
        "dto.CreateServiceOrderPartRequest": {
            "type": "object",
            "required": [
                "part_id",
                "quantity"
        ...
        "dto.CreateServiceOrderRequest": {
            ...
            "properties": {
                ...
                "parts": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.CreateServiceOrderPartRequest"
                    }
                },
                "services": {
                    "type": "array",
        ...
        "dto.ServiceOrderResponse": {
            ...
            "properties": {
                ...
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.ServiceOrderItemResponse"
                    }
                },
                "notes": {
                    "type": "string"
                ...
                "parts": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.ServiceOrderPartResponse"
                    }
                },
                "started_at": {
                    "type": "string"
        ...
        "valueobject.OrderStatus": {
            ...
            "x-enum-varnames": [
                "OrderStatusReceived",
                "OrderStatusInDiagnosis",
                "OrderStatusWaitingApproval",
                "OrderStatusInExecution",
                "OrderStatusFinished",
